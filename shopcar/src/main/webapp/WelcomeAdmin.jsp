		...
		<table align="center" border="1px" width="100%" height="100%">
			...
			<tr>
				<td colspan="1" width="120" height="80" align="center"
					style="font-size: 18px;"><a href="gtype/list.html">商品类别管理</a></td>
				<td colspan="9" rowspan="5" align="center" style="font-size: 30px;">欢迎<%=session.getAttribute("username")%>来到商品后台管理系统
				</td>
			</tr>
			<tr>
				<td colspan="1" width="120" height="80" align="center"
